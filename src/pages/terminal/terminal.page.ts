...
export class TerminalPage extends BasePage {
  ...
  protected override readyLocator(): Locator { return this.terminalsPageTitle; }

  // ---------------------------------------------------------------------------
  // List section
  // ---------------------------------------------------------------------------
  get terminalsPageTitle(): Locator { return this.page.getByRole("heading", { name: "Terminals" }); }
  get newTerminalButton(): Locator { return this.page.getByRole("link", { name: "New Terminal" }); }
  get terminalNameFilter(): Locator { return this.page.getByRole("combobox", { name: "Filter by Terminal Name" }); }
  get serialNumberFilter(): Locator { return this.page.getByRole("combobox", { name: "Filter by Serial Number" }); }
  get deviceFilter(): Locator { return this.page.getByRole("combobox", { name: "Filter by Device" }); }
  get resetFiltersButton(): Locator { return this.page.getByRole("button", { name: "Reset filters" }); }
  get terminalTable(): Locator { return this.page.getByRole("table"); }
  get terminalRows(): Locator { return this.page.getByRole("row"); }

  // ---------------------------------------------------------------------------
  // Add section
  // ---------------------------------------------------------------------------
  get addTerminalText(): Locator { return this.page.getByRole("heading", { name: "Add New Terminal" }); }
  get deviceSelect(): Locator { return this.page.getByTestId("terminals-form-device"); }
  get deviceSelectDetails(): Locator { return this.page.getByText("- Select Device"); }
  get terminalNameInput(): Locator { return this.page.getByTestId("terminals-form-name"); }
  get serialNumberInput(): Locator { return this.page.getByTestId("terminals-form-serial-number"); }

  // Processor settings
  get processorSettingsHeading(): Locator { return this.page.getByRole("heading", { name: "Processor Settings" }); }
  get addProcessorButton(): Locator { return this.page.getByRole("button", { name: "Add Processor" }); }
  get processorSelect(): Locator { return this.page.getByRole("combobox", { name: "Processor *" }); }
  get processorSearchInput(): Locator { return this.page.getByPlaceholder("Search processor..."); }
  get midInput(): Locator { return this.page.getByRole("textbox", { name: "MID *" }); }
  get tidInput(): Locator { return this.page.getByRole("textbox", { name: "TID *" }); }
  get binInput(): Locator { return this.page.getByRole("textbox", { name: "BIN *" }); }
  get applicationIdInput(): Locator { return this.page.getByRole("textbox", { name: "Application ID *" }); }
  get deviceIdInput(): Locator { return this.page.getByRole("textbox", { name: "Device ID *" }); }
  get developerIdInput(): Locator { return this.page.getByRole("textbox", { name: "Developer ID *" }); }
  get vitalNumberInput(): Locator { return this.page.getByRole("textbox", { name: "Vital Number *" }); }
  get agentInput(): Locator { return this.page.getByRole("textbox", { name: "Agent *" }); }
  get chainInput(): Locator { return this.page.getByRole("textbox", { name: "Chain *" }); }
  get locationNumberInput(): Locator { return this.page.getByRole("textbox", { name: "Location Number *" }); }
  get storeNumberInput(): Locator { return this.page.getByRole("textbox", { name: "Store Number *" }); }
  get debitSharingGroupInput(): Locator { return this.page.getByRole("textbox", { name: "Debit Sharing Group" }); }
  get debitSettlementAgentNumberInput(): Locator { return this.page.getByRole("textbox", { name: "Debit Settlement Agent Number" }); }
  get debitReimbursementAttributeSelect(): Locator { return this.page.getByRole("combobox", { name: "Debit Reimbursement Attribute" }); }
  get debitAmericanBankersInput(): Locator { return this.page.getByRole("textbox", { name: "Debit American Bankers" }); }
  get createTerminalButton(): Locator { return this.page.getByTestId("terminals-form-create-button"); }
  ...
  // Form filling
  // ---------------------------------------------------------------------------
  async fillTerminalName(name: string): Promise<void> { await this.terminalNameInput.fill(name); }
  ...
  async fillProcessorDetails(data: ProcessorDetailsData, processorIndex: number = 0): Promise<void> {
    ...
    if (data.applicationId) await this.page.getByRole("textbox", { name: "Application ID *" }).fill(data.applicationId);
    if (data.deviceId) await this.page.getByRole("textbox", { name: "Device ID *" }).fill(data.deviceId);
    if (data.developerId) await this.page.getByRole("textbox", { name: "Developer ID *" }).fill(data.developerId);
    if (data.vitalNumber) await this.page.getByRole("textbox", { name: "Vital Number *" }).fill(data.vitalNumber);
    ...
    if (data.locationNumber) await this.page.getByRole("textbox", { name: "Location Number *" }).fill(data.locationNumber);
    if (data.storeNumber) await this.page.getByRole("textbox", { name: "Store Number *" }).fill(data.storeNumber);
    if (data.debitSharingGroup) await this.page.getByRole("textbox", { name: "Debit Sharing Group" }).fill(data.debitSharingGroup);
    if (data.debitSettlementAgentNumber) await this.page.getByRole("textbox", { name: "Debit Settlement Agent Number" }).fill(data.debitSettlementAgentNumber);
    if (data.debitAmericanBankers) await this.page.getByRole("textbox", { name: "Debit American Bankers Association Number" }).fill(data.debitAmericanBankers);
  }
  ...
  // Verifications
  // ---------------------------------------------------------------------------
  async verifyProcessorDetails(data: ProcessorDetailsData, _processorIndex: number = 0): Promise<void> {
  ...
  async verifyDEMOProcessorData(
    terminalData: { device: string; name: string; serialNumber: string; processor: string; processorDetails: { mid: string; tid: string; bin: string } },
    processorIndex: number = 0
  ): Promise<void> {
    await this.verifyDEMOProcessorDetails(terminalData.processorDetails, processorIndex);
  }

  async closeButton(): Promise<void> { await this.page.getByRole("button", { name: "Close" }).click(); }
  ...
  async verifyDebitReimbursementAttribute(attributeName: string, _processorIndex: number = 0): Promise<void> {
    const v = await this.page.getByRole("combobox", { name: "Debit Reimbursement Attribute" }).inputValue();
    ...
    if (data.processor) {
      ...
      if (data.processorDetails) {
        ...
        if (data.processorDetails.debitReimbursementAttribute) {
          await this.selectDebitReimbursementAttribute(data.processorDetails.debitReimbursementAttribute);
        }
      }
    }
  }

  async fillTerminalRequiredFields(data: { device: string; name: string; serialNumber?: string }): Promise<void> {
    await this.selectDevice(data.device);
    await this.fillTerminalName(data.name);
    await this.fillSerialNumber(data.serialNumber);
  }

  async submitTerminalForm(): Promise<void> { await this.createTerminalButton.click(); }
  ...
  // Validations
  // ---------------------------------------------------------------------------
  async verifyFieldError(field: "device" | "name" | "serialNumber" | "processor" | "mid" | "tid" | "bin"): Promise<void> {
  ...
  async verifyActionSuccess(message: string): Promise<void> {
    await expect(this.page.locator('[data-sonner-toast][data-type="success"]')).toContainText(message);
  }
  ...
  async verifyDeviceRequired(): Promise<void> { await expect(this.page.locator(`text=Device is required`)).toBeVisible(); }
  async verifyNameRequired(): Promise<void> { await expect(this.page.locator(`text=Name is required`)).toBeVisible(); }
  async verifySerialNumberRequired(): Promise<void> { await expect(this.page.locator(`text=Serial Number is required`)).toBeVisible(); }
  ...
  async verifyMidRequired(): Promise<void> { await expect(this.page.locator('text="MID is required"')).toBeVisible(); }
  async verifyTidRequired(): Promise<void> { await expect(this.page.locator('text="TID is required"')).toBeVisible(); }
  async verifyBinRequired(): Promise<void> { await expect(this.page.locator('text="BIN is required"')).toBeVisible(); }

  // Length / type validation
  async verifyMidTooLong(): Promise<void> {
    await expect(this.page.locator('text="This value is too long. It should have 20 characters or less."')).toBeVisible();
  }
  ...
  async verifyTidTooLong(): Promise<void> {
    await expect(this.page.locator('text="This value is too long. It should have 10 characters or less."')).toBeVisible();
  }
  async verifyBinTooLong(): Promise<void> {
    await expect(this.page.locator('text="This value is too long. It should have 8 characters or less."')).toBeVisible();
  }
  ...
  async verifyApplicationIdTooLong(): Promise<void> {
    await expect(this.page.locator('text="This value is too long. It should have 15 characters or less."')).toBeVisible();
  }
  ...
  async verifyAgentTooLong(): Promise<void> {
    await expect(this.page.locator('text="This value is too long. It should have 6 characters or less."')).toBeVisible();
  }
  ...
  async verifyLocationNumberTooLong(): Promise<void> {
    await expect(this.page.locator('text="This value is too long. It should have 5 characters or less."')).toBeVisible();
  }
  async verifyLocationNumberInvalidType(): Promise<void> {
    await expect(this.page.locator('text="This value should be of type digit."')).toBeVisible();
  }
  async verifyStoreNumberTooLong(): Promise<void> {
    await expect(this.page.locator('text="This value is too long. It should have 4 characters or less."')).toBeVisible();
  }
  async verifyStoreNumberInvalidType(): Promise<void> {
    await expect(this.page.locator('text="This value should be of type digit."')).toBeVisible();
  }
  async verifyDebitSharingGroupTooLong(): Promise<void> {
    await expect(this.page.locator('text="This value is too long. It should have 30 characters or less."')).toBeVisible();
  }
  ...
  async verifyDebitAmericanBankersTooLong(): Promise<void> {
    await expect(this.page.locator('text="This value is too long. It should have 9 characters or less."')).toBeVisible();
  }
  ...
  async verifyApplicationIdRequired(): Promise<void> { await expect(this.page.locator('text="Application ID is required"')).toBeVisible(); }
  async verifyDeviceIdRequired(): Promise<void> { await expect(this.page.locator('text="Device ID is required"')).toBeVisible(); }
  async verifyDeveloperIdRequired(): Promise<void> { await expect(this.page.locator('text="Developer ID is required"')).toBeVisible(); }
  async verifyVitalNumberRequired(): Promise<void> { await expect(this.page.locator('text="Vital number is required"')).toBeVisible(); }
  async verifyAgentRequired(): Promise<void> { await expect(this.page.locator('text="Agent is required"')).toBeVisible(); }
  async verifyChainRequired(): Promise<void> { await expect(this.page.locator('text="Chain is required"')).toBeVisible(); }
  async verifyLocationNumberRequired(): Promise<void> { await expect(this.page.locator('text="Location number is required"')).toBeVisible(); }
  async verifyStoreNumberRequired(): Promise<void> { await expect(this.page.locator('text="Store number is required"')).toBeVisible(); }

  async verifyDuplicateProcessors(): Promise<void> { await expect(this.page.locator('text="Duplicate processors!"')).toBeVisible(); }
  async verifyDefaultProcessorRequired(): Promise<void> { await expect(this.page.locator('text="At least one processor must be default"')).toBeVisible(); }
  ...
  async editProcessor(processorIndex: number = 0): Promise<void> {
    if (processorIndex === 0) {
      await this.page.locator("div").filter({ hasText: /^Edit$/ }).getByRole("button").click();
    } else {
  ...
  async fillProcessorDetailsForIndex(index: number, details: ProcessorDetailsData): Promise<void> {
    ...
    if (details.applicationId) await section.locator('input[name*="applicationId"]').fill(details.applicationId);
    if (details.deviceId) await section.locator('input[name*="deviceId"]').fill(details.deviceId);
    if (details.developerId) await section.locator('input[name*="developerId"]').fill(details.developerId);
    if (details.vitalNumber) await section.locator('input[name*="vitalNumber"]').fill(details.vitalNumber);
    ...
    if (details.locationNumber) await section.locator('input[name*="locationNumber"]').fill(details.locationNumber);
    if (details.storeNumber) await section.locator('input[name*="storeNumber"]').fill(details.storeNumber);
    if (details.debitSharingGroup) await section.locator('input[name*="debitSharingGroup"]').fill(details.debitSharingGroup);
    if (details.debitSettlementAgentNumber) await section.locator('input[name*="debitSettlementAgentNumber"]').fill(details.debitSettlementAgentNumber);
    if (details.debitAmericanBankers) await section.locator('input[name*="debitAmericanBankers"]').fill(details.debitAmericanBankers);
  }
  ...
  async setProcessorAsDefault(index: number): Promise<void> {
    const section = this.page
      .locator(`[data-testid="processor-section-${index}"]`)
      .or(this.page.locator(`div:has-text("${index}")`).locator(".."));
    const toggle = section.locator('input[type="checkbox"]').or(section.locator('button:has-text("Default")'));
    await toggle.click();
  }
  ...
  async removeProcessor(index: number): Promise<void> {
    const section = this.page
      .locator(`[data-testid="processor-section-${index}"]`)
      .or(this.page.locator(`div:has-text("${index}")`).locator(".."));
    const removeBtn = section.locator('button[aria-label*="delete"]').or(section.locator("button:has(svg)").last());
  ...
  async verifyNameTooLong(): Promise<void> {
    await expect(this.page.locator('text="This value is too long. It should have 50 characters or less."')).toBeVisible();
  }

  async verifyNameTooShort(): Promise<void> {
    await expect(this.page.locator('text="This value is too short. It should have 5 characters or more."')).toBeVisible();
  }
  ...
  async verifySerialNumberTooShort(): Promise<void> {
    ...
    const updated = this.page.locator('text="This value is too short. It should have 10 characters or more."');
    const legacyVisible = await legacy.isVisible().catch(() => false);
    if (legacyVisible) await expect(legacy).toBeVisible();
    else await expect(updated).toBeVisible();
  }
  ...
  async verifySerialNumberInvalidCharacters(): Promise<void> {
    await expect(this.page.locator('text="Serial Number can only contain letters and numbers, and cannot contain spaces"')).toBeVisible();
  }

  // Field value verifications
  async verifyDeviceValue(v: string): Promise<void> { await expect(this.deviceSelect).toContainText(v); }
  async verifyTerminalNameValue(v: string): Promise<void> { await expect(this.terminalNameInput).toHaveValue(v); }
  async verifySerialNumberValue(v: string): Promise<void> { await expect(this.serialNumberInput).toHaveValue(v); }

  async verifyProcessorValue(v: string, processorIndex: number = 0): Promise<void> {
    await expect(this.page.getByRole("combobox", { name: "Processor *" }).nth(processorIndex)).toHaveValue(v);
  }
  ...
  async verifyTerminalWithAllFilters(name: string, serialNumber: string, device: string): Promise<boolean> {
    await expect(this.terminalTable).toBeVisible();
    try {
